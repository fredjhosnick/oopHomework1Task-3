...
public class MainVektor {
	...
	public static void main(String[] args) {
		...
		System.out.println("The vektor product of vektors1 is: " + vektors1.vektorproduct());
		System.out.println("-----------------------------------------------------------");
		...
		System.out.println("The vektor product of vektors2 is: " + vektors2.vektorproduct());
