...
public class MainVektor {
	...
	public static void main(String[] args) {
		...
		System.out.println("The  vektor sum of vektors1 is: " + vektors1.sumVecorsx() + "; " + vektors1.sumVecorsy()
				+ "; " + vektors1.sumVecorsz());
		System.out.println();
		...
		System.out.println("The  vektor sum of vektors2 is: " + vektors2.sumVecorsx() + "; " + vektors2.sumVecorsy()
				+ "; " + vektors2.sumVecorsz());
		System.out.println();
